...
export default function SearchEmptyState({ query, hasFilters }: SearchEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="mb-2 text-xl font-semibold text-foreground">No records found</h2>
